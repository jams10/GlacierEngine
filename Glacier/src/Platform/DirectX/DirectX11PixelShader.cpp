...
namespace Glacier
{
	DirectX11PixelShader::DirectX11PixelShader(const std::wstring& shaderFilePath)
	{
		...
		DirectX11System::GetInstance()->GetDirectX11Device()->CreatePixelShader(
	...
	{
		DirectX11System::GetInstance()->GetDirectX11DeviceContext()->PSSetShader(m_shader.Get(), 0, 0);
	}

	void DirectX11PixelShader::Unbind() const
	{
		DirectX11System::GetInstance()->GetDirectX11DeviceContext()->PSSetShader(nullptr, 0, 0);
	}
