...
namespace Glacier
{
	DirectX11VertexShader::DirectX11VertexShader(const std::wstring& shaderFilePath)
	{
		...
		DirectX11System::GetInstance()->GetDirectX11Device()->CreateVertexShader(
	...
	{
		DirectX11System::GetInstance()->GetDirectX11DeviceContext()->VSSetShader(m_shader.Get(), 0, 0);
	}

	void DirectX11VertexShader::Unbind() const
	{
		DirectX11System::GetInstance()->GetDirectX11DeviceContext()->VSSetShader(nullptr, 0, 0);
	}
