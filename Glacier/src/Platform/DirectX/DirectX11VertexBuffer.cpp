...
#pragma region Vertex Buffer
	...
	DirectX11VertexBuffer::DirectX11VertexBuffer(float* vertices, uint32 size)
	{
		...
		THROWFAILED(DirectX11System::GetInstance()->GetDirectX11Device()->CreateBuffer(&bufferDesc, &vertexBufferData, m_gpuBuffer.GetAddressOf()));
	}
	...
	{
		DirectX11System::GetInstance()->GetDirectX11DeviceContext()->IASetVertexBuffers(0, 1, m_gpuBuffer.GetAddressOf(), &m_stride, &m_offset);
	}

	void DirectX11VertexBuffer::Bind(const uint32& stride) const
	{
		DirectX11System::GetInstance()->GetDirectX11DeviceContext()->IASetVertexBuffers(0, 1, m_gpuBuffer.GetAddressOf(), &stride, &m_offset);
	}

	void DirectX11VertexBuffer::Unbind() const
	{
		DirectX11System::GetInstance()->GetDirectX11DeviceContext()->IASetVertexBuffers(0, 1, nullptr, nullptr, nullptr);
	}
